...
<body>
    ...
    <form action="#" method="post" id="form">
      <div id="form-body">
        <div id="welcome-lines">
          ...
          <div id="welcome-line-2">Please Login</div>
        </div>
  ...
  <script>
    document.getElementById('form').addEventListener('submit', function(e) {
      ...
      fetch('http://localhost/document_api/api/user/login.php', {  // Replace with your actual API endpoint
        method: 'POST',
        headers: {
      ...
      .then(data => {
        if (data.token) {
          ...
          window.location.href = '/document_api/public/dashboard.php'; // Redirect
        } else {
      ...
      .catch(error => {
        ...
        showToast('There was an error with the login process.', 'error');
      });
    });
